...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-bg-base flex flex-col relative">
      {/* Ambient orbs */}
      <div
        className="fixed w-[500px] h-[400px] rounded-full pointer-events-none z-0 animate-orb-float"
        style={{
          background: "rgba(255,80,10,0.07)",
          filter: "blur(120px)",
          top: "-100px",
          left: "-150px",
        }}
      />
      <div
        className="fixed w-[400px] h-[350px] rounded-full pointer-events-none z-0"
        style={{
      ...
      >
        <div className="max-w-6xl mx-auto h-full px-4 grid grid-cols-3 items-center gap-4">
          ...
          <div className="flex items-center justify-start">
            <button
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.boxShadow =
                  "var(--shadow-hover), 0 0 15px rgba(255,106,0,0.2)";
                e.currentTarget.style.transform = "translateY(-2px)";
                e.currentTarget.style.borderColor =
                  "var(--border2, rgba(255,106,0,0.2))";
              }}
              onMouseLeave={(e) => {
            ...
            >
              <span
                className="block h-[2px] rounded-full mx-auto"
                style={{ width: "20px", background: "var(--muted2)" }}
              />
              <span
                className="block h-[2px] rounded-full mx-auto"
                style={{ width: "20px", background: "var(--muted2)" }}
          ...
          >
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(255,235,190,0.18) 0%, transparent 50%)",
                }}
              />
            </div>
            <span
              className="text-2xl text-text-primary tracking-wider hidden sm:block"
          ...
          {NAV.map(({ href, label, icon: Icon, desc }) => {
            ...
            return (
              <Link
                ...
                href={href}
                onClick={() => setMenuOpen(false)}
                className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm relative overflow-hidden group"
                style={
                  active
                    ? {
                        background:
                        ...
                        color: "white",
                        boxShadow:
                          "0 0 12px rgba(255,106,0,0.35), inset 0 1px 0 rgba(255,255,255,0.15)",
                      }
                    : {
                        color: "var(--muted2)",
              ...
              >
                {active && (
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg, rgba(255,235,190,0.12) 0%, transparent 50%)",
                    }}
                  />
                )}
                ...
                <div className="relative z-10 flex-1 min-w-0">
                  ...
                  <p
                    ...
                    style={{
                      color: active ? "rgba(255,255,255,0.75)" : "var(--muted)",
                    }}
                  >
                    {desc}
                  </p>
                ...
                {active && (
                  <ChevronRight className="w-3.5 h-3.5 ml-auto relative z-10 shrink-0" />
                )}
              </Link>
            );
          })}
      ...
      <main className="flex-1 pt-16 relative z-10">
        {/* ── WEBSITE INFO SECTION (only on the upload/home tab) ── */}
        {pathname === "/dashboard/upload" && (
          <section className="max-w-6xl mx-auto px-4 pt-10 pb-8">
            ...
            <div className="text-center max-w-2xl mx-auto mb-10">
              ...
              >
                Distribute your tracks to Spotify, Apple Music, YouTube, and
                TikTok in minutes. No complex setups. No hidden fees. Just
                pure music distribution.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                ...
                <div
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.boxShadow =
                      "var(--shadow-hover), 0 0 15px rgba(255,106,0,0.12)";
                    e.currentTarget.style.transform = "translateY(-2px)";
                    e.currentTarget.style.borderColor =
                      "var(--border2, rgba(255,106,0,0.2))";
                  }}
